...
export default function DashboardPage() {
    ...
    if (error) {
        return <div className="p-8 text-center text-red-600">Error loading dashboard: {error}. Ensure the backend server is running.</div>;
    }
    ...
    const { kpis, areaChartData: areaData } = data;
